...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 31 18:39:23 2021
...
# Perform the distance transform algorithm
distance = cv2.distanceTransform(thresh, distanceType=cv2.DIST_L2, maskSize=3)
# Normalize the distance image for range = {0.0, 1.0}
# so we can visualize and threshold it
cv2.normalize(distance, distance, 0, 1.0, cv2.NORM_MINMAX)
cv2.imshow('Distance Transform Image', distance)
cv2.waitKey()
