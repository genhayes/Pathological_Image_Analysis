...
BULK ANALYSIS
Main Multi Template Matching Pipeline
...
for filename in os.listdir(directory):
    if filename.endswith(".tiff") or filename.endswith(".tiff"):
        ...
        filename_save = 'TemplateMatching/TemplateMatching_Analysis_Outputs.txt'
        ...
        df.to_csv('TemplateMatching/TemplateMatching_Batch_Results.csv', mode='a', index = False, header=None)
