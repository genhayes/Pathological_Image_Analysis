...
B_kpgn_tm = 0.0
B_kngn_tm = 246.0
xB_tm = np.array(["Template Matching"])
...
D_kpgn_tm = 1.0
D_kngn_tm = 897.0
xD_tm = np.array(["Template Matching"])
...
G_kpgn_tm = 0.0
G_kngn_tm = 138.0
xG_tm = np.array(["Template Matching"])
